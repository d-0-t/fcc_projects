    ...
    .post(function (req, res) {
      ...
      ProjectModel.findOne({ name: project }, (err, data) => {
        ...
        data.save((err, updata) => {
          ...
          res.json(updata.issues[updata.issues.length - 1]);
        });
      });
    })
    ...
    .put(function (req, res) {
      ...
      ProjectModel.findOne({ name: project }, (err, data) => {
        if (err) {
          ...
          issueToMod.issue_title =
            req.body.issue_title || issueToMod.issue_title;
          issueToMod.issue_text =
            req.body.issue_text || issueToMod.issue_text;
          issueToMod.created_by =
            req.body.created_by || issueToMod.created_by;
          issueToMod.assigned_to =
            req.body.assigned_to || issueToMod.assigned_to;
          issueToMod.status_text =
            req.body.status_text || issueToMod.status_text;
